        ...
        <Box sx={{width:'100%', height:'100%', overflow:'scroll'}}>
            ...
            <Box sx={{width:'100%', height:'20%'}}>
                <Box sx={{width:'100%', display:'flex', height:'100%'}}>
                    <Box sx={{width:'30%', display:'flex', justifyContent:'center', alignItems:'flex-end', height:'100%', flexDirection:'column'}}>
                        {/* logo and social */}
                        <Typography variant="h4" color="primary" sx={{fontWeight:'bold'}}>LearnEd</Typography>
                        <Box>
